...
atlas_username = 'jaiganesh'
atlas_password = 'jai'
atlas_cluster = 'Cluster0'
client = MongoClient(
    f"mongodb+srv://{atlas_username}:{atlas_password}@{atlas_cluster}.xsi4wpb.mongodb.net/?retryWrites=true&w=majority")
# mongodb+srv://jaiganesh:<password>@cluster0.xsi4wpb.mongodb.net/?retryWrites=true&w=majority
# mongosh "mongodb+srv://cluster0.xsi4wpb.mongodb.net/" --apiVersion 1 --username jaiganesh
db = client['youtube_data']
collection = db['channel_data']
# api_key
Api_key = 'AIzaSyAJcuM9j96d8ZqbjwXr2GxUrijvd0Iq94U'
